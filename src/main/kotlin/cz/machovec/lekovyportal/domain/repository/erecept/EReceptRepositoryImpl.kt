...
class EReceptRepositoryImpl : EReceptRepository {
    ...
    override fun findAggregatesByDistrict(
        ...
        """.trimIndent())
            ...
            if (fromYear != null && fromMonth != null) append(" AND (year > :fromYear OR (year = :fromYear AND month >= :fromMonth)) ")
            if (toYear != null && toMonth != null) append(" AND (year < :toYear OR (year = :toYear AND month <= :toMonth)) ")
