...
@Repository
class DistFromMahsRepositoryImpl(
    private val jdbcTemplate: JdbcTemplate
) : DistFromMahsRepositoryCustom {

    @Transactional
    override fun batchInsert(records: List<DistFromMahs>, batchSize: Int) {
        val sql = """
            INSERT INTO dist_from_mahs
